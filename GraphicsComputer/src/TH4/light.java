...
public class light extends GLCanvas {
     ...
     */
    private void myinit () {
	float mat_specular[] = { 1.0f, 0.0f, 0.0f, 1.0f }; // mau phan xa
	float mat_shininess[] = { 50.0f }; // do muot smooth
	float mat_ambient[] = { 1.0f, 1.0f, 0.0f, 1.0f };// mau xung quanh
	float mat_emission[] = { 0.0f, 0.0f, 1.0f, 1.0f };// mau phat sang
